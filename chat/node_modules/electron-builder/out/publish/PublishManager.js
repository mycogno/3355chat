    ...
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, publishConfigs) {
        ...
        if (publishConfigs.length === 0) {
            ...
            if (repositoryInfo != null && repositoryInfo.type === "github") {
                const resolvedPublishConfig = yield getResolvedPublishConfig(packager.info, { provider: repositoryInfo.type }, false);
    ...
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, targetSpecificOptions) {
        ...
        if (publishers == null) {
            ...
            if (serviceName != null) {
                ...
                return [yield getResolvedPublishConfig(packager.info, { provider: serviceName })];
            }
        }
        if (publishers == null) {
            return [];
        ...
        return yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map((0, (_electronBuilderUtil || _load_electronBuilderUtil()).asArray)(publishers), function (it) {
            return getResolvedPublishConfig(packager.info, typeof it === "string" ? { provider: it } : it);
...
let getResolvedPublishConfig = (() => {
    var _ref6 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager, options) {
        let getInfo = (() => {
    ...
    return function getResolvedPublishConfig(_x13, _x14) {
...
class PublishManager {
        ...
        packager.addAfterPackHandler((() => {
            var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (event) {
                ...
                if (providerClass != null && providerClass.modifyPublishConfig != null) {
                    publishConfig = yield providerClass.modifyPublishConfig(publishConfig);
                }
    ...
    artifactCreated(event) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            const packager = event.packager;
            const target = event.target;
            const publishConfigs = event.publishConfig == null ? yield getPublishConfigs(packager, target == null ? null : target.options) : [event.publishConfig];
